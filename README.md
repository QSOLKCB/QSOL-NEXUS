...
```text
protocol: nexus/0.13
runtime version: 2.0.0-alpha9.3
operator TUI version: 2.0.0-alpha9.3
...
world modes: analytical / historical / pure_history / cultural / meme_casual / clinical_differential / house_fun / cbt_learning / roman_orator / house_of_wisdom / ultimate_questions / game_un / game_mud
