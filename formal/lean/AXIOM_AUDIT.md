...
This document defines the trust boundary for the advertised #52 theorem surface.
...
PR #53 must archive the final #52 axiom-audit output together with:

- the exact #52 commit SHA;
...
> The advertised theorem surface is enumerated, proof-hole scanned, kernel-checked, axiom-dependency audited, and bound to an exact formalization commit and toolchain identity.
