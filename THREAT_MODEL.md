...
### T33 — Hidden table information leaks into Council evidence
...
### T34 — Model narration becomes a game mutation
...
### T35 — Forged or nondeterministic game state
...
### T36 — Human-only DORK gains an AI authority path
